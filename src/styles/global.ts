...
export const createGlobalStyles = (theme: typeof lightTheme) => StyleSheet.create({
  ...
  LoginButtonDisabled: {
    backgroundColor: theme.colors.background === '#0A0A0A' ? '#404040' : theme.colors.surface,
    paddingVertical: theme.spacing.md,
    paddingHorizontal: theme.spacing.lg,
    borderRadius: theme.borderRadius.md,
    alignItems: "center",
  ...
  socialButton: {
    ...
    backgroundColor: theme.colors.socialButtonBackground || theme.colors.card,
    marginTop: theme.spacing.md,
    shadowColor: theme.colors.shadowColor || "#000",
    shadowOffset: { width: 0, height: 2 },
    shadowOpacity: 0.1,
  ...
  modalOverlay: {
    flex: 1,
    backgroundColor: theme.colors.background === '#0A0A0A' ? "rgba(0,0,0,0.8)" : "rgba(0,0,0,0.5)",
    justifyContent: "center",
    alignItems: "center",
    padding: theme.spacing.lg,
  },
  ...
  // Estilos base para search (SIN marginHorizontal)
  searchWrapper: {
    position: 'relative',
    marginBottom: theme.spacing.md,
    width: '100%',
